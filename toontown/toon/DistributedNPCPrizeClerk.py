...
from toontown.toonfest import PrizeClerkPurchase
...
class DistributedNPCPrizeClerk(DistributedNPCToonBase):
    ...
    def popupPurchaseGUI(self, task):
        ...
        self.purchase = PrizeClerkPurchase.PrizeClerkPurchase(base.localAvatar, self.remain, self.purchaseDoneEvent)
        self.purchase.load()
        self.purchase.enter()
        return Task.done
