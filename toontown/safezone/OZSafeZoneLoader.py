...
class OZSafeZoneLoader(SafeZoneLoader):
    ...
    def load(self):
        ...
        if self.geyserModel:
            ...
            self.geyserActor.setBlend(frameBlend = config.ConfigVariableBool('want-smooth-animations', False).getValue())
        ...
        if self.waterfallModel:
            ...
            self.waterfallActor.setBlend(frameBlend = config.ConfigVariableBool('want-smooth-animations', False).getValue())
