...
CogData = [{'parentEntId': LobbyParent, # Lobby
  'boss': 0,
  'level': ToontownGlobals.SellbotScrapFactoryCogLevel(),
 ...
 {'parentEntId': CenterSiloParent, # Center Silo Control Room 
  'boss': 1, # Supervisor
  'level': ToontownGlobals.SellbotScrapFactorySupervisorLevel(),
 ...
 {'parentEntId': CenterSiloParent,
  'boss': 0, 
  'level': ToontownGlobals.SellbotScrapFactoryControlRoomMediumLevel(), 
  'battleCell': CenterSiloCell,
  'pos': Point3(-2, 0, 0),
  'h': 0,
  'behavior': 'stand',
 ...
 {'parentEntId': CenterSiloParent,
  'boss': 0,
  'level': ToontownGlobals.SellbotScrapFactoryControlRoomHigherLevel(),
  'battleCell': CenterSiloCell,
  'pos': Point3(2, 0, 0),
  'h': 0,
  'behavior': 'stand',
 ...
 {'parentEntId': WestSiloParent, # West Silo
  'boss': 0,
  'level': ToontownGlobals.SellbotScrapFactorySiloMediumLevel(),
 ...
 {'parentEntId': WestSiloParent,
  'boss': 0,
  'level': ToontownGlobals.SellbotScrapFactorySiloHigherLevel(),
  'battleCell': WestSiloCell,
  'pos': Point3(10, 0, 0),
  'h': 0,
  'behavior': 'chase',
