...
class MailboxInteractiveProp(InteractiveAnimatedProp.InteractiveAnimatedProp):
    ...
    ZoneToIdles = {ToontownGlobals.ToontownCentral: (('tt_a_ara_ttc_mailbox_idleWobble',
                                        3,
                                        10,
                                        'tt_a_ara_ttc_mailbox_idleWobbleSettle',
                                        3,
                                        10),
                                       ('tt_a_ara_ttc_mailbox_idleLook2',
                                        1,
                                        1,
                                        None,
                                        3,
                                       ...
                                       ('tt_a_ara_ttc_mailbox_idleLook1',
                                        ...
                                        3,
                                        10),
                                       ('tt_a_ara_ttc_mailbox_idleJumpSpin',
                                        1,
                                        1,
                                        None,
                                        3,
    ...
    def setupActor(self, node):
        ...
        self.pieActor.setBlend(frameBlend = config.ConfigVariableBool('want-smooth-animations', False).getValue())
