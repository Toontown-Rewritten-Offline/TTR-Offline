...
class DistributedElectionEvent(DistributedObject, FSM):
    ...
    def enterPreShow(self, offset):
        ...
        self.surleeLeaveInterval = Sequence(Wait(7), Parallel(Func(self.surlee.removeActive), Func(self.surlee.hide), Func(self.surleeR.show), Func(self.surleeR.addActive), Func(self.surleeR.startBlink)), Wait(3), Func(self.surleeR.setChatAbsolute, 'Hrm, you heard the HQ. I better get out of the way before Alec arrives.', CFSpeech | CFTimeout), Wait(1), Parallel(Func(self.surleeR.loop, 'walk'), self.surleeR.posHprInterval(4, (-20, 0, 0), (190, 0, 0))), Parallel(Func(self.surleeR.loop, 'neutral'), self.surleeR.head.hprInterval(1, (75, 30, 0), blendType='easeInOut')), Wait(1), Func(self.surleeR.setChatAbsolute, "Oh, do you like it? Designed it myself. Don't worry about getting close to the ropes; the TV will be showing a live feed for everyone to get a great view.", CFSpeech | CFTimeout), Func(self.surleeR.loop, 'walk'), Parallel(self.surleeR.hprInterval(1, (80, 0, 0)), self.surleeR.head.hprInterval(1, (0, 0, 0), blendType='easeInOut')), Func(self.surleeR.loop, 'neutral'), Wait(8), Func(self.surleeR.setChatAbsolute, 'I know you all will keep trying to jump on top of each other for a better view anyway, though, so try not to hurt anyone.', CFSpeech | CFTimeout), Wait(3), Func(self.surleeR.loop, 'run'), self.surleeR.posHprInterval(2, (-17, -7, 0), (180, 0, 0)), self.surleeR.posHprInterval(1.5, (-15, -15, 0), (190, 0, 0)), Func(self.surleeR.loop, 'walk'), self.surleeR.posHprInterval(2, (-20, -18, 0), (90, 0, 0)), self.surleeR.posHprInterval(3.5, (-32, -19, 0), (35, 0, 0)), self.surleeR.posHprInterval(1, (-34, -17, 0), (0, 0, 0)), self.surleeR.posHprInterval(1.5, (-32, -15, 0), (-40, 0, 0)), Func(self.surleeR.loop, 'neutral'))
    ...
    def enterInvasion(self, offset):
        ...
        self.surleeIntroInterval = Sequence(Func(self.surleeR.loop, 'walk'), Func(self.surleeR.setChatAbsolute, "Everyone, listen. There's no time to explain!", CFSpeech | CFTimeout), self.surleeR.posHprInterval(1, (-32, -15, 0), (50, 0, 0)), Func(self.surleeR.loop, 'neutral'), Parallel(self.alec.head.hprInterval(1, (15, 0, 0), blendType='easeInOut')), self.flippy.head.hprInterval(1, (80, 0, 0), blendType='easeInOut'), Parallel(Func(self.flippy.loop, 'walk'), self.flippy.hprInterval(2, (95, 0, 0)), self.flippy.head.hprInterval(2, (0, 0, 0))), Func(self.flippy.loop, 'neutral'), Wait(2), Func(self.surleeR.setChatAbsolute, 'Grab the pies, they seem to be the weakness of these...', CFSpeech | CFTimeout), Wait(5), Func(self.surleeR.setChatAbsolute, '..."Cogs."', CFSpeech | CFTimeout), Wait(3), Func(self.surleeR.setChatAbsolute, "Now take up arms, there's more on the way!", CFSpeech | CFTimeout), Wait(3), Func(self.alecRunAway.start, offset), Wait(2), Func(self.surleeR.setChatAbsolute, 'Fight for our town. Fight for Slappy!', CFSpeech | CFTimeout), Wait(7), Wait(3), Parallel(Func(self.surlee.show), Func(self.surlee.addActive), Func(self.surleeR.hide), Func(self.surleeR.removeActive), Func(self.surleeAnimation.loop, offset)), Func(self.surlee.setChatAbsolute, "Flippy, I'm going to need you over here to help with the pies. Can you get cooking?", CFSpeech | CFTimeout), Wait(7), Func(self.flippy.setChatAbsolute, 'I can certainly try.', CFSpeech | CFTimeout), Wait(1), Func(self.flippy.loop, 'run'), self.flippy.posHprInterval(3.5, (-38, -18.5, 0), (100, 0, 0)), Func(self.flippy.loop, 'walk'), self.flippy.posHprInterval(1.5, (-38, -18.5, 0), (75, 0, 0)), Func(self.flippy.loop, 'neutral'))
    ...
    def enterWrapUp(self, offset):
        ...
        self.logo = loader.loadModel('phase_3/models/gui/toontown-logo').find('**/logo')
        ...
        self.cameraSequence = Sequence(base.camera.posHprInterval(10, (75, -9.5, 12), (-90, -10, 0), blendType='easeInOut'), Func(self.wrapUpSequence.start), Wait(12), Parallel(self.logo.posHprScaleInterval(6.5, (0, 0, 0), 0, 0.25, blendType='easeOut'), self.logo.colorScaleInterval(6.5, Vec4(1, 1, 1, 1), blendType='easeOut'), base.camera.posHprInterval(7.5, (70, 0.6, 42.2), (-90, 0, 0), blendType='easeInOut')), Parallel(self.logo.colorScaleInterval(0.3, Vec4(1, 1, 1, 0)), base.camera.posHprInterval(0.3, (85, 0, 42), (-90, -30, 0), blendType='easeIn')), Parallel(base.camera.posHprInterval(0.9, (95, 0.6, 6), (-90, -90, 0), blendType='easeOut'), self.portal.scaleInterval(0.5, 2)))
