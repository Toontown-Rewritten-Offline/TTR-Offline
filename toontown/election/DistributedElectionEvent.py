...
class DistributedElectionEvent(DistributedObject, FSM):
    ...
    def __init__(self, cr):
        ...
        self.counterLeft.setBlend(frameBlend = config.GetBool('want-smooth-animations', False))
        ...
        self.counterRight.setBlend(frameBlend = config.GetBool('want-smooth-animations', False))
