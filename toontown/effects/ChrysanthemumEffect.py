...
class ChrysanthemumEffect(NodePath, EffectController):
    ...
    def __init__(self):
        ...
        self.effectModel = loader.loadModel('phase_4/models/props/ttr_m_efx_ext_fireworkBurst_tflip')
        self.effectModel.setColorScale(Point4(0, 0, 0, 0))
        self.effectModel.reparentTo(self)
        self.seqNode = self.effectModel.getChild(0).getChild(0).node()
        self.effectModel2 = loader.loadModel('phase_4/models/props/ttr_m_efx_ext_fireworkBurst_tflip')
