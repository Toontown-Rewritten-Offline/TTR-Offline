...
PIEOWNER_GREETING4 = "I've got a FABULOUS set of prizes, with your name on them."
...
PIEOWNER_GOODBYE3 = "Until next time, buddy. I've got plenty of prizes in store!"
...
ToonfestPieTypeName = 'Throwable Item'
ToonfestPieAmount = '%(amount)s %(name)s'
ToonfestTokenCost = '%s Tokens'
ToonfestVerifyPurchase = 'Purchase %(item)s for %(price)s ToonFest Tokens?'
