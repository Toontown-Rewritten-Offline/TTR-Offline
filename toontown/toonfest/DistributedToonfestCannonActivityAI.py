...
class DistributedToonfestCannonActivityAI(DistributedToonfestActivityAI):
    notify = DirectNotifyGlobal.directNotify.newCategory("DistributedToonfestCannonActivityAI")
