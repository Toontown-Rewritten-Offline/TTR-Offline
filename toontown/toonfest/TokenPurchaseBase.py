...
class TokenPurchaseBase(StateData.StateData):
    ...
    def load(self, tokenGUI = None):
        if self.tokenGUI == None:
        ...
        self.tokens = loader.loadModel('phase_6/models/gui/ttr_m_tf_gui_tokens')
        self.jarImage = self.tokens.find('**/jar')
